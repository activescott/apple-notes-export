 ...
 */
export function createFileAtPath(path: string): void {
  const nilContents = $()
  const nilAttributes = $()
...
export function moveItem(srcPath: NSString, dstPath: NSString): void {
 ...
 */
export function fileHandleForWritingAtPath(path: string): NSFileHandle {
