...
declare class NSFileManager extends NSObject<NSFileManager> {
   ...
   */
  public defaultManager: NSFileManager
   ...
   * @param error
   */
  public createDirectoryAtPathWithIntermediateDirectoriesAttributesError(
    path: string,
   ...
   */
  public moveItemAtPathToPathError(
    srcPath: NSString,
    dstPath: NSString,
