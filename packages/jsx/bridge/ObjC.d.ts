declare class ObjC {
   ...
   */
  public static import(framework: string): void
   ...
   */
  public static unwrap<TJSType>(objc: BridgedObject<TJSType>): TJSType
  ...
  public static deepUnwrap<TJSType>(objc: BridgedObject<TJSType>): TJSType
   ...
   * https://developer.apple.com/library/archive/releasenotes/InterapplicationCommunication/RN-JavaScriptForAutomation/Articles/OSX10-10.html#//apple_ref/doc/uid/TP40014508-CH109-SW22
   */
  public static wrap<TJSType>(obj: TJSType): BridgedObject<TJSType>
}
